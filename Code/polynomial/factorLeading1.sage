...
comments = "General Comments: We are looking for two numbers that multiple to be $%s$ and add to be $%s$. When in doubt, list the products in order!" %(constantC, constantB)
...
print "Finished compiling Objective 2!"
