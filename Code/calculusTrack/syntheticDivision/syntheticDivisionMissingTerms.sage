...
print "Starting Module 11 Objective 2"
...
distractor2Interval.append(" You multipled by the synthetic number rather than bringing the first factor down.")
distractor3Interval.append(" You divided by the opposite of the factor AND multipled the first factor rather than just bringing it down.")
distractor4Interval.append(" You multipled by the synthetic number and subtracted rather than adding during synthetic division.")
...
generalComments = "General Comments: Be sure to synthetically divide by the zero of the denominator! Also, make sure to include 0 placeholders for missing terms."
...
c2 = "a \in [%s, %s], b \in [%s, %s], c \in [%s, %s], \\text{ and } r \in [%s, %s]." %(answerList[2][0][0], answerList[2][0][1], answerList[2][1][0], answerList[2][1][1], answerList[2][2][0], answerList[2][2][1], answerList[2][3][0], answerList[2][3][1])
c3 = "a \in [%s, %s], b \in [%s, %s], c \in [%s, %s], \\text{ and } r \in [%s, %s]." %(answerList[3][0][0], answerList[3][0][1], answerList[3][1][0], answerList[3][1][1], answerList[3][2][0], answerList[3][2][1], answerList[3][3][0], answerList[3][3][1])
c4 = "a \in [%s, %s], b \in [%s, %s], c \in [%s, %s], \\text{ and } r \in [%s, %s]." %(answerList[4][0][0], answerList[4][0][1], answerList[4][1][0], answerList[4][1][1], answerList[4][2][0], answerList[4][2][1], answerList[4][3][0], answerList[4][3][1])
...
print "I have completed Module 11 Objective 1 Type 2, Master"
