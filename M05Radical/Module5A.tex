...
\begin{multicols}{2}
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/question23AA.png}
\end{center}
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/question23AB.png}
\end{center}
\columnbreak
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/question23AC.png}
\end{center}
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/question23AD.png}
\end{center}
\end{multicols}
	\end{enumerate}	
}
