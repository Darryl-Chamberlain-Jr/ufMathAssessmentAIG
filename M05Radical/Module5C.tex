...
\begin{multicols}{2}
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/question23CA.png}
\end{center}
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/question23CB.png}
\end{center}
\columnbreak
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/question23CC.png}
\end{center}
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/question23CD.png}
\end{center}
\end{multicols}
	\end{enumerate}	
}
